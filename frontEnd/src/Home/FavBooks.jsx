      ...
      <div className='md:w-1/2 space-y-6'>
        <h2 className='text-5xl font-bold my-5 md:w-3/4 leading-snug'>Find Your Favorite 
          ...
          <p className='mb-10 text-lg md:w-5/6'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat eligendi perspiciatis possimus molestiae, libero accusamus quaerat harum reprehenderit dolorum ea illo assumenda dolore pariatur officia! Adipisci, quos soluta. Repudiandae, iste.
          </p>
          {/* stats */}
